...
.pull-left[
**Problématique** : la méconnaissance d'un processus phasé et multi-acteur du traitement de la donnée peut inhiber d'emblée la contribution citoyenne.
...
**Solution** :
1. détailler les briques élémentaires et les ramener à leur pure utilité fonctionnelle ;
